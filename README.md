...
✅ **Anleitungen** – geführtes Umtopfen in zehn Schritten, mit Zeitpunkt, Anzeichen, Material und den typischen Fehlern
...
| Offline | Service Worker (`sw.js`), Cache `gruenzeug-v3.1.0` |
