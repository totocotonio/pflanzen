...
**Version:** v3.20.1 – Sync-Korrekturen; Deployment dieser Version noch ausstehend.
...
✅ **Düngerrechner** – Typ nach Art, Dosis auf die Gießmenge, halbiert bei Jungpflanzen, Winter und Kälte
...
✅ **Sammelaufgaben** – eine Tätigkeit für beliebig viele Pflanzen („alle 14 Tage auf Schädlinge kontrollieren“); Auswahl einzeln oder nach Standort, Intervall in Tagen oder Monaten, Abhaken einzeln und nach Zimmern gruppiert
...
## Tests und Sync-Prüfung

Installation der Testabhängigkeiten und Ausführung (Python 3.12+, Node.js 22+):
...
Die Python-Tests verwenden ausschließlich eine temporäre SQLite-Datenbank.
Die JavaScript-Tests prüfen die tatsächlichen App-Funktionen mit kontrollierten
Netzwerkantworten und Browser-Speichern. GitHub Actions führt beide Suiten aus.
...
| **v3.17.0** | Statistik: Aufwand, Problemzonen, Standort-Bilanz |
| **v3.16.0** | Winterstandort: wer muss ans Fenster |
...
| **v3.13.1** | Etikettendruck ergab ein weißes Blatt |
| **v3.13.0** | Düngerrechner, Wassermenge für die Gieß-Runde |
| **v3.12.0** | Schädlings-Frühwarnung nach Saison und Standort |
| **v3.11.0** | Wochenrückblick sonntags, abschaltbar |
| **v3.10.0** | Etikettenbogen: alle QR-Codes auf einer Seite |
...
| **v3.4.1** | Fotos in IndexedDB – der localStorage lief voll |
